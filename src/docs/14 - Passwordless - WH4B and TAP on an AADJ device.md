...
1. Once added, the details of the Temporary Access Pass are shown. Make a note of the Temporary Access Pass value as you will not be able to view this value again for this pass after you select **Ok**. You can always create another TAP for the user if you happen to forget what it is.
